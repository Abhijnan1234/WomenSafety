...
video_path = 'data/videos/CAM03.mp4'
    ...
    if frame_idx % 30 == 0:  # Assuming 30 FPS
        ...
        with open(csv_path, "a", newline="") as f:
            ...
            for idx, cluster in enumerate(clusters):
                ...
                camera_id = "CAM_03"  # or your actual camera ID
                latitude = "25.716106421162003"  # example latitude
                longitude = "76.65532112505879" # example longitude
